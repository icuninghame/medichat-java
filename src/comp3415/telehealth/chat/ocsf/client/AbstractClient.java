 ...
 * up the cuninghame.comp3415projectphase1.client side of a cuninghame.comp3415projectphase1.client-server architecture. When a cuninghame.comp3415projectphase1.client is thus
...
public abstract class AbstractClient implements Runnable {
	...
	/**
	 * Constructs the cuninghame.comp3415projectphase1.client.
	 * 
	 * @param host
	 *            the server's host name.
	 * @param port
