...
package comp3415.telehealth.chat.ocsf.client;
...
// ACCESSING METHODS ------------------------------------------------
  ...
  /**
   * @used to find out if the cuninghame.comp3415projectphase1.client is connnected.
   */
   ...
   * Only has effect if the cuninghame.comp3415projectphase1.client is not currently connected.
   *
  ...
  /**
   * @return the cuninghame.comp3415projectphase1.client's Inet address.
   */
   ...
   * is raised by the cuninghame.comp3415projectphase1.client listening thread.
   *
