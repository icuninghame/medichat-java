...
public class ObservableServer extends Observable
{
  ...
  /**
   * The string sent to the observers when a comp3415.telehealth.chat.client has connected.
   */
  public static final String CLIENT_CONNECTED= "#OS:Client connected.";

  /**
   * The string sent to the observers when a comp3415.telehealth.chat.client has disconnected.
   */
  public static final String CLIENT_DISCONNECTED= "#OS:Client disconnected.";

  /**
   * The string sent to the observers when an exception occurred with a comp3415.telehealth.chat.client.
  ...
  /**
   * Sends a message to every comp3415.telehealth.chat.client connected to the server.
   *
...
// ACCESSING METHODS ------------------------------------------------
   ...
   * comp3415.telehealth.chat.client connections. This can be used by
   ...
   * comp3415.telehealth.chat.client connection, ignoring any exception.
   * The method may be overridden by subclasses.
   *
  ...
  /**
   * This method is used to handle messages coming from the comp3415.telehealth.chat.client.
   * Observers are notfied by receiveing the transmitted message.
   * Note that, in this implementation, the information concerning
   * the comp3415.telehealth.chat.client that sent the message is lost.
   * It can be overriden, but is still expected to call notifyObservers().
   *
   * @param message The message received from the comp3415.telehealth.chat.client.
   * @param client The connection to the comp3415.telehealth.chat.client.
   * @see comp3415.telehealth.chat.ocsf.server.ObservableOriginatorServer
   */
