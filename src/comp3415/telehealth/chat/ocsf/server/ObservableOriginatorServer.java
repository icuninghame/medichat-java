...
* @see comp3415.telehealth.chat.ocsf.server.OriginatorMessage
*/
public class ObservableOriginatorServer extends ObservableServer
{
   ...
   * comp3415.telehealth.chat.client who sent the message.
   *
  ...
  /**
   * Method called each time a new comp3415.telehealth.chat.client connection is
   * accepted. It notifies observers by sending an
   * <code> OriginatorMessage </code> instance
   * containing a reference to that comp3415.telehealth.chat.client and
  ...
  /**
   * Method called each time a comp3415.telehealth.chat.client connection is
   ...
   * by a comp3415.telehealth.chat.client connection.
