...
* @see comp3415.telehealth.chat.ocsf.server.ConnectionToClient
*/
public abstract class AbstractServer implements Runnable
{
  ...
  /**
   * The thread group associated with comp3415.telehealth.chat.client threads. Each member of the
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
  ...
  /**
   * Handles a command sent from one comp3415.telehealth.chat.client to the server.
...
// METHODS TO BE USED FROM WITHIN THE FRAMEWORK ONLY ----------------
  ...
  /**
   * Receives a command sent from the comp3415.telehealth.chat.client to the server.
